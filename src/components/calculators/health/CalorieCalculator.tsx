        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription className="text-gray-100 mt-2">
              Estimate your daily calorie needs based on your physical
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ToggleGroup
                ...
                onValueChange={(value) => {
                  if (value) setUnitSystem(value as "metric" | "imperial");
                }}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="bg-blue-50">
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold">
                      {results.maintenance} calories/day
                    </p>
                    <p className="text-sm text-muted-foreground">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <Card className="bg-green-50">
                    ...
                    <CardContent>
                      <p className="text-lg font-bold">
                        {results.moderateLoss} calories/day
                      </p>
                      <p className="text-xs text-muted-foreground">
                        ~0.5 kg/week
                      </p>
                  ...
                  <Card className="bg-green-50">
                    ...
                    <CardContent>
                      <p className="text-lg font-bold">
                        {results.extremeLoss} calories/day
                      </p>
                      <p className="text-xs text-muted-foreground">
                        ~1 kg/week
                      </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <Card className="bg-amber-50">
                    ...
                    <CardContent>
                      <p className="text-lg font-bold">
                        {results.moderateGain} calories/day
                      </p>
                      <p className="text-xs text-muted-foreground">
                        ~0.5 kg/week
                      </p>
