      ...
      return (
        <div className="bg-white p-4 border rounded shadow-sm">
          ...
          <p>
            ...
            {((payload[0].value / income) * 100).toFixed(1)}%)
          </p>
        </div>
      );
    }
        ...
        >
          ...
          <TabsContent value="annual" className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <Input
                    ...
                    value={income}
                    onValueChange={(val) =>
                      setIncome(typeof val === "string" ? 0 : Number(val))
                    }
                    onClear={() => setIncome(0)}
                  />
                </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="isBonus">
                Calculate as bonus income (applies supplemental tax rate)
              </Label>
            </div>
