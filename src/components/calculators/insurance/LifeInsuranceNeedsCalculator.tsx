...
const LifeInsuranceNeedsCalculator = () => {
  ...
  }, [annualIncome, age, yearsOfIncome, dependents, existingInsurance, existingSavings, expenses]);
  ...
  return (
    <div className="space-y-6">
        ...
        <TabsContent value="basic" className="space-y-4">
          <Card className="p-6">
            ...
            <div className="mt-4 space-y-2">
              <Label>Income Replacement Period (Years): {yearsOfIncome}</Label>
              <Slider
                value={[yearsOfIncome]}
                min={5}
                max={30}
          ...
          <Card className="p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="existing-insurance">Existing Life Insurance</Label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-muted-foreground">$</span>
                  <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="existing-savings">Existing Savings/Assets</Label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-muted-foreground">$</span>
                  <Input
                    id="existing-savings"
        ...
        <TabsContent value="advanced" className="space-y-4">
          <Card className="p-6">
            ...
            <div className="grid gap-4">
              <div className="space-y-2">
                <Label htmlFor="final-expenses">Final Expenses (Funeral, Medical, etc.)</Label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-muted-foreground">$</span>
                  <Input
                    id="final-expenses"
                    ...
                    onChange={(e) => handleExpenseChange('finalExpenses', Number(e.target.value))}
                    className="pl-7"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleExpenseChange('mortgage', Number(e.target.value))}
                    className="pl-7"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="other-debts">Other Debts (Credit Cards, Loans, etc.)</Label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-muted-foreground">$</span>
                  <Input
                    id="other-debts"
                    ...
                    onChange={(e) => handleExpenseChange('otherDebts', Number(e.target.value))}
                    className="pl-7"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="education-fund">Education Fund for Children</Label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-muted-foreground">$</span>
                  <Input
                    id="education-fund"
                    ...
                    onChange={(e) => handleExpenseChange('educationFund', Number(e.target.value))}
                    className="pl-7"
                  />
                </div>
              </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="p-6">
          <h3 className="text-xl font-semibold mb-6 text-center">Life Insurance Needs Analysis</h3>
          
          <div className="space-y-4">
            <div className="flex justify-between items-center py-2 border-b">
              <span className="font-medium">Total Financial Needs:</span>
              <span className="text-xl font-bold">{formatCurrency(needsAnalysis.totalNeeds)}</span>
            </div>
            
            <div className="flex justify-between items-center py-2 border-b">
              <span className="font-medium">Existing Coverage:</span>
              <span className="text-xl">{formatCurrency(needsAnalysis.existingCoverage)}</span>
            </div>
            
            <div className="flex justify-between items-center py-2 border-b">
              <span className="font-medium">Additional Insurance Needed:</span>
              <span className="text-xl font-bold text-primary">{formatCurrency(needsAnalysis.additionalNeeded)}</span>
            </div>
          </div>
        ...
        <Card className="p-6">
          <h3 className="text-xl font-semibold mb-6 text-center">Needs Breakdown</h3>
      ...
      <Card className="p-6 bg-muted/20">
        ...
        <p className="text-muted-foreground text-sm">
          This calculator provides a general estimate of your life insurance needs based on the information provided. For a more comprehensive analysis and personalized recommendations, consider consulting with a licensed insurance professional.
        </p>
      </Card>
    </div>
  );
