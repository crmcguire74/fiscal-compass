...
const AutoInsuranceCalculator = () => {
  ...
  const calculatePremium = () => {
    ...
    const liabilityLimitFactor =
      limits.bodilyInjury === "250/500"
        ? 1.3
        : limits.bodilyInjury === "100/300"
        ? 1.1
        : 1;

    const propertyLimitFactor =
      limits.propertyDamage === "100"
        ? 1.2
        : limits.propertyDamage === "50"
        ? 1.1
        : 1;

    const collisionDeductibleFactor =
      limits.collisionDeductible === "1000"
        ? 0.85
        : limits.collisionDeductible === "500"
        ? 1
        : 1.15;

    const compDeductibleFactor =
      limits.comprehensiveDeductible === "1000"
        ? 0.85
        : limits.comprehensiveDeductible === "500"
        ? 1
        : 1.15;

    // Calculate individual coverages
    const liabilityCost = coverage.liability
      ? baseRates.liability *
        ageFactor *
        recordFactor *
        mileageFactor *
        liabilityLimitFactor *
        propertyLimitFactor
      : 0;

    const collisionCost = coverage.collision
      ? baseRates.collision *
        vehicleTypeFactor *
        vehicleAgeFactor *
        recordFactor *
        collisionDeductibleFactor *
        (vehicleValue / 20000)
      : 0;

    const comprehensiveCost = coverage.comprehensive
      ? baseRates.comprehensive *
        vehicleTypeFactor *
        vehicleAgeFactor *
        compDeductibleFactor *
        (vehicleValue / 20000)
      : 0;

    const uninsuredCost = coverage.uninsured
      ? baseRates.uninsured * ageFactor * mileageFactor
      : 0;

    const medicalCost = coverage.medicalPayments
      ? baseRates.medicalPayments * (limits.medicalPayments === "10" ? 1.2 : 1)
      : 0;

    const roadsideCost = coverage.roadside ? baseRates.roadside : 0;

    const rentalCost = coverage.rentalReimbursement
      ? baseRates.rentalReimbursement
      : 0;
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription className="text-gray-100 mt-2">
              Calculates the optimal coverage levels for your vehicles and
              driving habits.
            </CardDescription>
          </div>
        </div>
          ...
          <TabsContent value="vehicle" className="space-y-4">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="vehicle-age">
                    Vehicle Age (Years): {vehicleAge}
                  </Label>
                  <Slider
                    id="vehicle-age"
                    value={[vehicleAge]}
          ...
          <TabsContent value="driver" className="space-y-4">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="driving-record">
                    Driving Record (Last 3 Years)
                  </Label>
                  <Select
                    value={drivingRecord}
                    onValueChange={setDrivingRecord}
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="minor">
                        Minor Violations (1-2 Tickets)
                      </SelectItem>
                      <SelectItem value="major">
                        Major Violation (1 Accident or DUI)
                      </SelectItem>
                ...
                <div className="space-y-2">
                  <Label htmlFor="annual-mileage">
                    Annual Mileage: {annualMileage.toLocaleString()}
                  </Label>
                  <Slider
                    id="annual-mileage"
                    value={[annualMileage]}
              ...
              <div className="space-y-4">
                ...
                {coverage.liability && (
                  <div className="ml-6 grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="bodily-injury">
                        Bodily Injury Limits
                      </Label>
                      <Select
                        value={limits.bodilyInjury}
                        onValueChange={(value) =>
                          handleLimitChange("bodilyInjury", value)
                        }
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleLimitChange("propertyDamage", value)
                        }
                      >
              ...
              <div className="space-y-4">
                ...
                {coverage.collision && (
                  <div className="ml-6 space-y-2">
                    <Label htmlFor="collision-deductible">
                      Collision Deductible
                    </Label>
                    <Select
                      value={limits.collisionDeductible}
                      onValueChange={(value) =>
                        handleLimitChange("collisionDeductible", value)
                      }
                    >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Covers damage not caused by collision (theft, weather,
                      etc.)
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={() =>
                      handleCoverageToggle("comprehensive")
                    }
                  />
                </div>
                ...
                {coverage.comprehensive && (
                  <div className="ml-6 space-y-2">
                    <Label htmlFor="comprehensive-deductible">
                      Comprehensive Deductible
                    </Label>
                    <Select
                      value={limits.comprehensiveDeductible}
                      onValueChange={(value) =>
                        handleLimitChange("comprehensiveDeductible", value)
                      }
                    >
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Protection if you're hit by a driver with no or
                ...
                <div className="flex items-start justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={() =>
                      handleCoverageToggle("medicalPayments")
                    }
                  />
                </div>
                ...
                {coverage.medicalPayments && (
                  <div className="ml-6 space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleLimitChange("medicalPayments", value)
                      }
                    >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <Label htmlFor="roadside" className="text-base font-medium">
                      Roadside Assistance
                    </Label>
                    <p className="text-sm text-muted-foreground mt-1">
                      Help with breakdowns, flat tires, or lockouts
                    </p>
                  </div>
                  <Switch
                    id="roadside"
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <Label htmlFor="rental" className="text-base font-medium">
                      Rental Car Reimbursement
                    </Label>
                    <p className="text-sm text-muted-foreground mt-1">
                      Covers rental car costs if your vehicle is being repaired
                    </p>
                  </div>
                  <Switch
                    id="rental"
                    ...
                    onCheckedChange={() =>
                      handleCoverageToggle("rentalReimbursement")
                    }
                  />
                </div>
              </div>
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 p-4 bg-primary/10 rounded-lg">
              <div className="text-center md:text-left mb-4 md:mb-0">
                ...
                <div className="text-3xl font-bold text-primary">
                  {formatCurrency(estimatedPremium.total)}
                </div>
              </div>
              <div className="text-center md:text-right">
                ...
                <div className="text-2xl font-bold">
                  {formatCurrency(estimatedPremium.monthly)}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {estimatedPremium.liability > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.liability)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.collision > 0 && (
                <div className="flex justify-between py-2 border-b">
                  <span>Collision</span>
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.collision)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.comprehensive > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.comprehensive)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.uninsured > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.uninsured)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.medicalPayments > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.medicalPayments)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.roadside > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.roadside)}
                  </span>
                </div>
              )}
              ...
              {estimatedPremium.rentalReimbursement > 0 && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">
                    {formatCurrency(estimatedPremium.rentalReimbursement)}
                  </span>
                </div>
              )}
            ...
            <div className="mt-6 p-4 bg-yellow-50 rounded-lg flex items-start">
              ...
              <div className="text-sm text-yellow-700">
                ...
                <p>
                  This is only an estimate based on the information provided.
                  Actual premiums will vary based on additional factors
                  including credit score, location, exact vehicle details, and
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Most experts recommend at least 100/300/50 in liability
                  coverage to adequately protect your assets.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Choose a deductible you can comfortably afford in case of an
                  accident. Lower deductibles mean higher premiums.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  For newer vehicles or those with loans, comprehensive and
                  collision coverage is usually recommended or required.
                </p>
              </div>
            </div>
          </div>
