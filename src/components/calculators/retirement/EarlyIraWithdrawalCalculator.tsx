...
const QUALIFIED_REASONS = [
  {
    id: "none",
    name: "None (No Exemption)",
    description: "Standard early withdrawal with no exemption",
  },
  {
    id: "first-home",
    name: "First-time Home Purchase",
    description: "Up to $10,000 lifetime limit",
  },
  {
    id: "education",
  ...
  {
    id: "medical",
    name: "Unreimbursed Medical Expenses",
    description: "Medical expenses exceeding 7.5% of your AGI",
  },
  {
    id: "health-insurance",
    name: "Health Insurance Premiums",
    description: "While unemployed",
  },
  {
    id: "disability",
    name: "Total and Permanent Disability",
    description: "Full exemption if permanently disabled",
  },
  {
    id: "military",
    name: "Qualified Reservist Distribution",
    description: "For military reservists called to active duty",
  },
  {
    id: "birth-adoption",
    name: "Birth or Adoption Expenses",
    description: "Up to $5,000 per child",
  },
];
...
const EarlyIraWithdrawalCalculator = () => {
  ...
  const [withdrawalAmount, setWithdrawalAmount] = useState(
    DEFAULTS.withdrawalAmount
  );
  const [age, setAge] = useState(DEFAULTS.age);
  const [accountType, setAccountType] = useState<"traditional" | "roth">(
    DEFAULTS.accountType
  );
  const [federalTaxBracket, setFederalTaxBracket] = useState(
    DEFAULTS.federalTaxBracket
  );
  ...
  const [hasQualifiedReason, setHasQualifiedReason] = useState(
    DEFAULTS.hasQualifiedReason
  );
  const [qualifiedReason, setQualifiedReason] = useState(
    DEFAULTS.qualifiedReason
  );
  const [
    payWithdrawalPenaltyFromOtherFunds,
    setPayWithdrawalPenaltyFromOtherFunds,
  ] = useState(DEFAULTS.payWithdrawalPenaltyFromOtherFunds);
  const [ruleOf55Applies, setRuleOf55Applies] = useState(
    DEFAULTS.ruleOf55Applies
  );
  ...
  useEffect(() => {
    ...
    if (savedData) {
      setWithdrawalAmount(
        savedData.withdrawalAmount ?? DEFAULTS.withdrawalAmount
      );
      setAge(savedData.age ?? DEFAULTS.age);
      setAccountType(
        (savedData.accountType as "traditional" | "roth") ??
          DEFAULTS.accountType
      );
      setFederalTaxBracket(
        savedData.federalTaxBracket ?? DEFAULTS.federalTaxBracket
      );
      ...
      setHasQualifiedReason(
        savedData.hasQualifiedReason ?? DEFAULTS.hasQualifiedReason
      );
      setQualifiedReason(savedData.qualifiedReason ?? DEFAULTS.qualifiedReason);
      setPayWithdrawalPenaltyFromOtherFunds(
        savedData.payWithdrawalPenaltyFromOtherFunds ??
  ...
  const calculateResults = () => {
    ...
    const isRothAccountWithQualifyingContributions =
    ...
    const isPenaltyExempt =
      isOver59AndHalf || hasQualifiedReason || ruleOf55Applies || isSepp;
    ...
    // Calculate taxes
    const federalTaxAmount = isTaxableWithdrawal
      ? withdrawalAmount * federalTaxRate
      : 0;
    ...
    const stateTaxAmount = isTaxableWithdrawal
      ? calculateStateIncomeTax(withdrawalAmount, selectedState)
      : 0;
    ...
    const effectiveTaxRate =
      withdrawalAmount > 0 ? (totalCost / withdrawalAmount) * 100 : 0;
  ...
  const handleSaveData = () => {
    ...
    toast({
      title: "Data Saved",
      description:
        "Your early IRA withdrawal calculator data has been saved locally.",
    });
  };
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription className="text-gray-100 mt-2">
              Calculate the taxes and penalties on early retirement account
              withdrawals
            </CardDescription>
          </div>
          {dataStored && (
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    value={accountType}
                    onValueChange={(value: "traditional" | "roth") =>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="federalTaxBracket">
                      Federal Tax Bracket
                    </Label>
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="w-80">
                          <p className="text-xs">
                            Your marginal tax bracket. This is a simplified
                            calculation since your actual tax situation may be
                            more complex.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                ...
                <div className="space-y-2 border-t pt-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="hasQualifiedReason">
                        Have a Qualified Exception Reason
                      </Label>
                    </div>
                  </div>
                  ...
                  {hasQualifiedReason && (
                    <div className="ml-6 mt-2">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {
                          QUALIFIED_REASONS.find(
                            (r) => r.id === qualifiedReason
                          )?.description
                        }
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label
                        htmlFor="ruleOf55"
                        className={age < 55 ? "text-muted-foreground" : ""}
                      >
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="isSepp">
                        Using SEPP (72t) Distributions
                      </Label>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="payPenaltyFromOtherFunds">
                        Pay Taxes/Penalties From Other Funds
                      </Label>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-xl font-semibold">
                          {formatCurrency(results.grossWithdrawal)}
                        </p>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg border p-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-medium">
                          {formatCurrency(results.earlyWithdrawalPenalty)}
                        </span>
                      </div>
                      <div className="text-xs text-muted-foreground">
                  ...
                  <div className="bg-gray-50 rounded-lg border p-4 text-sm">
                    ...
                    <ul className="space-y-2 list-disc pl-5">
                      {age < 59.5 && !results.isPenaltyExempt && (
                        <li>
                          Early withdrawal penalty applies because you're under
                          age 59½ without qualifying for an exception.
                        </li>
                      )}

                      {results.isPenaltyExempt && (
                        <li>
                          You're exempt from the 10% early withdrawal penalty
                          due to{" "}
                          {age >= 59.5
                      ...
                      {accountType === "roth" && age >= 59.5 && (
                        <li>
                          Qualified Roth IRA distributions are completely
                          tax-free.
                        </li>
                      )}
                      ...
                      {accountType === "roth" &&
                        ...
                        !results.isPenaltyExempt && (
                          <li>
                            For Roth IRAs, you can withdraw contributions (but
                            not earnings) at any time without taxes or
                            penalties. This calculator assumes you're
                      ...
                      {payWithdrawalPenaltyFromOtherFunds && (
                        <li>
                          You've chosen to pay taxes and penalties from other
                          funds, so they won't reduce your withdrawal amount.
                        </li>
                      )}
                    </ul>
                  </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold mb-3">
                IRA Withdrawal Rules (2024)
              </h3>
              <p className="text-muted-foreground">
                Understanding the rules and penalties for IRA withdrawals can
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  Withdrawals from Traditional IRAs are generally taxed as
                  ordinary income at your current tax bracket. This applies to
                  both principal and earnings.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  Withdrawals before age 59½ are typically subject to a 10%
                  early withdrawal penalty in addition to regular income taxes,
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  You must begin taking RMDs by April 1 following the year you
                  turn 73 (for those born between 1951-1959) or 75 (for those
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  You can withdraw your original Roth IRA contributions at any
                  time, tax and penalty-free, regardless of age.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  Earnings can be withdrawn tax and penalty-free if your Roth
                  account is at least 5 years old AND you're at least 59½,
                  disabled, using up to $10,000 for a first-time home purchase,
                  or withdrawals are made by your beneficiary after your death.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  Roth IRAs aren't subject to RMDs during the account owner's
                  lifetime.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                The following exceptions may apply to both Traditional and Roth
                IRAs:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    Up to $10,000 lifetime limit (per person) for a first-time
                    home purchase.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    Qualified expenses for yourself, spouse, children, or
                    grandchildren.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    Unreimbursed medical expenses exceeding 7.5% of your
                ...
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    While unemployed for at least 12 weeks.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    Distributions to your beneficiary or estate after your
                    death.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg border p-4">
                  ...
                  <p className="text-sm">
                    Up to $5,000 within one year of birth or adoption of a
                    child.
                  </p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p className="mb-2">
                  If you leave your job in or after the year you turn 55, you
                  can withdraw from that employer's 401(k) or 403(b) plan
                  without the 10% early withdrawal penalty.
                </p>
                <p className="text-sm text-muted-foreground">
                  Note: This applies to 401(k)/403(b) plans, not IRAs. However,
                  it's included in this calculator for comparison purposes.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                ...
                <p>
                  ...
                  expectancy. These payments must continue for 5 years or until
                  you reach age 59½, whichever is longer.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-700">
                ...
                provide and current tax laws. Tax rules are complex and subject
                to change. For personalized advice, consult with a qualified tax
      ...
      <CardFooter className="bg-gray-50 border-t p-4 text-sm text-muted-foreground">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p>
              This calculator provides a simplified estimate of potential taxes
              and penalties. Actual results may vary based on your complete tax
              situation, including other income, deductions, and tax credits.
              State tax treatment of retirement account withdrawals varies by
              state.
            </p>
          </div>
        </div>
