...
import { Calculator, TrendingUp, ArrowRight, ChevronRight, Info } from 'lucide-react';
...
const INVESTMENT_CALCULATORS = [
  {
    ...
    description: 'See how your money can grow with regular contributions and compound interest',
    icon: TrendingUp,
    featured: true,
    status: 'active',
    complexity: 'beginner',
  },
  {
    ...
    description: 'Analyze your investment portfolio diversification and risk assessment',
    icon: Calculator,
    featured: false,
    status: 'coming-soon',
    complexity: 'advanced',
  },
  {
    ...
    description: 'Compare returns of different investment types and asset classes',
    icon: Calculator,
    featured: false,
    status: 'coming-soon',
  ...
  },
  {
    ...
    description: 'Calculate how regular investments can reduce volatility impact',
    icon: Calculator,
    featured: false,
    status: 'coming-soon',
    complexity: 'beginner',
...
const InvestmentCalculatorsIndex = () => {
  ...
  const activeCalculators = INVESTMENT_CALCULATORS.filter(calc => calc.status === 'active');
  const beginnerCalculators = INVESTMENT_CALCULATORS.filter(calc => calc.complexity === 'beginner');
  const intermediateCalculators = INVESTMENT_CALCULATORS.filter(calc => calc.complexity === 'intermediate');
  const advancedCalculators = INVESTMENT_CALCULATORS.filter(calc => calc.complexity === 'advanced');
    ...
    <Layout>
      ...
      <div className="bg-gradient-to-r from-finance-primary to-finance-primary/90 text-white py-12">
        <div className="container">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl font-bold font-heading mb-4">Investment & Wealth Calculators</h1>
            <p className="text-xl text-white/90">
              Tools to help you plan, project, and optimize your investments for long-term wealth building
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container py-12">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Our collection of investment planning tools</p>
        </div>
        ...
        <div className="mt-16 text-center bg-white p-8 rounded-lg border shadow-sm">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
            We're constantly adding new calculators to help with your financial planning.
      ...
      <div className="bg-white py-12 border-t">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-semibold mb-4">How to Use Our Investment Calculators</h2>
            <div className="bg-white rounded-lg p-6 border">
              <ol className="list-decimal pl-6 space-y-4">
                <li>
                  <p className="font-medium">Choose the right calculator for your needs</p>
                ...
                <li>
                  <p className="font-medium">Enter your personal financial information</p>
                ...
                <li>
                  ...
                  <p className="text-muted-foreground">Analyze charts, graphs, and detailed breakdowns to understand your financial projections.</p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p className="text-muted-foreground">Try different values to compare outcomes and make better financial decisions.</p>
                </li>
              </ol>
            </div>
          </div>
...
const CalculatorCard = ({ calculator }) => {
  return (
    <div
      className={`border rounded-lg overflow-hidden transition-all bg-white ${calculator.status === 'active'
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {calculator.description} It helps you make informed decisions about your investments.
                      </p>
                    </div>
                    <div className="grid gap-1">
                      <h4 className="text-sm font-medium">Difficulty level:</h4>
                      <div className="text-sm">
                        <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${calculator.complexity === 'beginner' ? 'bg-green-100 text-green-800' :
