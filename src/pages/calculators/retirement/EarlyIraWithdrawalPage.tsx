      ...
      <div className="container py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 mt-4">
            ...
            <p className="mb-4">
              Withdrawing money from your IRA before retirement age can have
              significant tax implications and may incur penalties.
              Understanding these consequences can help you make informed
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Several exceptions exist that may waive the 10% penalty
                  </li>
                  <li>
                    Roth IRA contributions (but not earnings) can be withdrawn
                    anytime
                  </li>
                  <li>
                    Tax impact varies based on your overall income and tax
                    bracket
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Consider taking a loan from your 401(k) instead (if
                    available)
                  </li>
                  <li>
                    Look into Substantially Equal Periodic Payments (SEPP/72t)
                  </li>
                  <li>Explore if you qualify for any penalty exceptions</li>
                  <li>Use Roth IRA contributions first (if applicable)</li>
                  <li>
                    Evaluate other sources of funds before tapping retirement
                    accounts
                  </li>
                </ul>
              </div>
