    ...
    <Layout>
      <div className="container py-8 max-w-7xl">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-100 mt-2">
                    Calculate how much of your bonus you'll actually receive
                    after taxes.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 mt-4">
          ...
          <p className="mb-4">
            Bonuses are typically considered "supplemental wages" by the IRS and
            are often subject to different withholding rules than your regular
            paycheck.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  The IRS allows for a flat 22% federal withholding rate on
                  bonuses up to $1 million
                </li>
                <li>
                  For bonuses exceeding $1 million, the rate increases to 37%
                  for the amount over $1 million
                </li>
                ...
                <li>
                  Your employer may also withhold for retirement plans if
                  applicable
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Consider increasing your 401(k) contribution for the pay
                  period with your bonus
                </li>
                <li>
                  Ask your employer about timing options for receiving your
                  bonus
                </li>
                <li>
                  Be aware that bonus withholding is often higher than your
                  actual tax rate
                </li>
                <li>
                  Remember that your final tax liability is determined when you
                  file your tax return
                </li>
                <li>
                  Consider setting aside some of your bonus for estimated tax
                  payments if withholding seems insufficient
                </li>
              </ul>
            </div>
          </div>
