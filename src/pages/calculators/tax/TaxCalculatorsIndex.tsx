...
const TAX_CALCULATORS = [
  ...
  },
  {
    ...
    description:
      "Estimate your federal and state income tax liability based on income and deductions",
    icon: Calculator,
    status: "coming-soon",
    featured: false,
  },
  {
    ...
    description:
      "Calculate potential capital gains tax on investments and property sales",
    icon: Calculator,
    status: "coming-soon",
  },
];
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90">
              Tools to help you estimate your take home income as well as tax
              liabilities and plan your tax strategy
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container py-12">
        <div className="mb-10">
          ...
          <p className="text-muted-foreground">
            Tools to help with tax planning and estimation
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-white p-8 rounded-lg border shadow-sm">
          ...
          <h2 className="text-2xl font-semibold mb-2">
            Tax Calculators Coming Soon
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
            We're currently developing a suite of tax calculators to help you
            plan your tax strategy and estimate your tax liabilities. Check back
            soon for these useful tools.
          </p>
          <Link to="/contact">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-6 border">
              <p className="mb-4">Effective tax planning can help you:</p>
              <ul className="list-disc pl-6 space-y-3">
                <li>
                  <p className="font-medium">Reduce your tax liability</p>
                  <p className="text-muted-foreground">
                    Identify deductions, credits, and strategies to minimize
                    taxes legally.
                  </p>
                </li>
                <li>
                  ...
                  <p className="text-muted-foreground">
                    Estimate your tax bill in advance to avoid surprises at tax
                    time.
                  </p>
                </li>
                <li>
                  ...
                  <p className="text-muted-foreground">
                    Understand the tax implications of investment, retirement,
                    and income choices.
                  </p>
                </li>
                <li>
                  ...
                  <p className="text-muted-foreground">
                    Anticipate how marriage, children, retirement, or property
                    sales affect your taxes.
                  </p>
                </li>
              </ul>
              <div className="mt-4 px-4 py-3 bg-yellow-50 rounded-lg text-yellow-800 text-sm">
                <p>
                  <strong>Note:</strong> These calculators provide estimates for
                  informational purposes only. For personalized tax advice,
