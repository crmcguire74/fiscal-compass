...
import TakeHomePayHourlyCalculator from "@/components/calculators/tax/TakeHomePayHourlyCalculator"; // Updated import

const TakeHomePayHourlyPage = () => {
  // Renamed component
  return (
    <Layout>
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold tracking-tight text-2xl flex items-center gap-2">
                    ...
                    Take-Home Pay Calculator (Hourly) {/* Updated title */}
                  </h3>
                  <p className="text-sm text-gray-100 mt-2">
                    Estimate your take-home pay based on hourly rate, hours
                    worked, tips, taxes, and deductions.{" "}
                    {/* Updated description */}
                  </p>
                </div>
              </div>
            </div>
            <TakeHomePayHourlyCalculator /> {/* Updated component */}
          </div>
        </div>
...
export default TakeHomePayHourlyPage; // Updated export
