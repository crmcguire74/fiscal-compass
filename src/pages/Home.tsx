...
const Home = () => {
  ...
  const featuredCategories = [
    ...CALCULATOR_CATEGORIES.slice(0, 5),
    {
      id: "education",
      name: "Education Planning",
      description:
        "Plan for future education costs with savings strategies and loan management tools",
      icon: Book,
    },
  ];
    ...
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-finance-primary to-finance-primary/90 text-white py-16 md:py-24">
        <div
          ...
          className="absolute inset-0 bg-grid-white/10 bg-[length:20px_20px] bg-blue-950"
        ></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="font-bold font-heading leading-tight animate-fade-in">
                <span className="whitespace-nowrap text-[1.7rem] md:text-4xl block">
                  Free Financial Calculators{" "}
                </span>
                <span className="text-finance-accent text-yellow-500 text-[2.1rem] md:text-[2.8rem] whitespace-nowrap block">
                  No Sign Up Required
                </span>
              </h1>
              <p
              ...
              >
                <Button
                  ...
                  className="bg-white text-finance-primary hover:bg-white hover:bg-yellow-500 hover:text-blue-950 hover:border-yellow-500 transition-all"
                >
                  Try a Calculator
                ...
                <Button
                  ...
                  className="border-white text-gray bg-blue-950 hover:bg-yellow-500 hover:text-blue-950 hover:border-yellow-500 transition-all"
                >
                  Learn More
                </Button>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20 shadow-xl w-full max-w-md">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-white/5 rounded p-2 text-lg font-bold text-finance-accent">
                      $336,458
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
              <div className="w-12 h-12 rounded-full bg-finance-primary/10 flex items-center justify-center mb-4">
                <svg
                  ...
                  className="h-6 w-6 text-finance-primary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <p className="text-muted-foreground">
                Use all our calculators without creating an account or sharing
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
              <div className="w-12 h-12 rounded-full bg-finance-secondary/10 flex items-center justify-center mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 text-finance-secondary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <p className="text-muted-foreground">
                Save your calculator inputs locally in your browser to easily
                revisit and update your calculations.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Interactive charts and graphs help you visualize and understand
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 md:p-12">
                ...
                <blockquote className="text-xl font-medium italic text-gray-900 mb-6">
                  "I've been using these calculators for my retirement planning
                  and they're so much easier than other tools I've tried. No
                  need to create an account or worry about my data being
                  collected."
                </blockquote>
              ...
              <div className="bg-gray-50 p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-muted-foreground mb-6">
                  We believe your financial information should remain yours.
                  That's why our calculators:
                </p>
                <ul className="space-y-3">
                  {[
                    "Never require email or personal information",
                    "Store data locally in your browser only",
                    "Don't track or analyze your financial inputs",
                    "Allow completely anonymous usage",
                    "Give you full control to delete saved data",
                  ].map((item, index) => (
      ...
      <section className="bg-finance-primary text-white py-16 bg-blue-950">
        <div className="container text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
            No registration, no email required. Just free, powerful calculators
